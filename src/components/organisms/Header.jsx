...
import { Settings, Bell, User, PictureInPicture2 } from 'lucide-react';
            ...
            <header className="fixed top-0 left-0 w-full flex items-center justify-between px-8 py-6 font-sans z-50 pointer-events-none">
                ...
                <div className="bg-white rounded-full pl-2 pr-2 py-2 flex items-center shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100/50 pointer-events-auto">
                    ...
                    <div className="flex items-center gap-2 mr-2">
                        {/* Mini Mode / PiP Button */}
                        <button
                            onClick={() => window.electron?.ipcRenderer?.send('app:mini-mode')}
                            className="flex items-center justify-center w-10 h-10 rounded-full hover:bg-gray-50 transition-colors text-gray-700"
                            title="Mini Mode"
                        >
