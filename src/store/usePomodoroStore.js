    ...
    persist(
        (set, get) => {
            ...
            return {
                ...
                lastTick: 0,
                completionTrigger: 0, // Increments whenever ANY timer finishes

                // Actions
                incrementCompletionTrigger: () => set((state) => ({ completionTrigger: (state.completionTrigger || 0) + 1 })),
                ...
                tick: () => {
                    ...
                    if (timeLeft > 0) {
                        ...
                        // Timer Finished
                        const { mode, sessionsCompleted, switchMode, incrementSession, incrementStreak, addActivityTime, addShortBreakTime, addLongBreakTime, incrementCompletionTrigger } = get();

                        // Trigger Alarm for ALL modes
                        incrementCompletionTrigger();
